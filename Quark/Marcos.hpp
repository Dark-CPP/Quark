...
#define decl_expansionRule(rule) RaiseMessage rule(NodePtr node, std::ostream& out)
#define decl_expansionRuleArgs(rule, args) void rule(NodePtr node, std::ostream& out, args)
